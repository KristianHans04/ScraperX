/**
 * Custom error classes for ScraperX
 */

export class ScraperXError extends Error {
...
// Resource Errors
export class InsufficientCreditsError extends ScraperXError {
...
export class RateLimitedError extends ScraperXError {
...
export class ConcurrentLimitError extends ScraperXError {
...
export class JobNotFoundError extends ScraperXError {
  constructor(jobId: string) {
    super(`Job not found: ${jobId}`, 'JOB_NOT_FOUND', 404, false);
  }
}

export class BatchNotFoundError extends ScraperXError {
...
// Scraping Errors
export class BlockedError extends ScraperXError {
...
export class CaptchaRequiredError extends ScraperXError {
...
export class CaptchaFailedError extends ScraperXError {
  constructor(message: string = 'Failed to solve CAPTCHA') {
    super(message, 'CAPTCHA_FAILED', 403, true);
  }
}

export class TimeoutError extends ScraperXError {
...
export class TargetError extends ScraperXError {
...
export class TargetUnavailableError extends ScraperXError {
...
// System Errors
export class InternalError extends ScraperXError {
  constructor(message: string = 'Internal server error') {
    super(message, 'INTERNAL_ERROR', 500, true);
  }
}

export class WorkerUnavailableError extends ScraperXError {
  constructor(message: string = 'No workers available') {
    super(message, 'WORKER_UNAVAILABLE', 503, true);
  }
}

export class ServiceMaintenanceError extends ScraperXError {
...
// Proxy Errors
export class ProxyError extends ScraperXError {
  constructor(message: string = 'Proxy error occurred') {
    super(message, 'PROXY_ERROR', 502, true);
  }
}

export class ProxyAuthenticationError extends ScraperXError {
...
// Database Errors
export class DatabaseError extends ScraperXError {
  constructor(message: string = 'Database error occurred') {
    super(message, 'DATABASE_ERROR', 500, true);
  }
}

export class DatabaseConnectionError extends ScraperXError {
...
/**
 * Convert unknown error to ScraperXError
 */
export function toScraperXError(error: unknown): ScraperXError {
  if (error instanceof ScraperXError) {
    return error;
  }
